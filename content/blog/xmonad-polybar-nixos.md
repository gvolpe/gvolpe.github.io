...
tags: ["nix", "nixos", "xmonad", "polybar", "wm", "windowmanager"]
...
**NOTE**: if you're already familiar with this and are only interested in the configuration files, you can find them [here](https://github.com/gvolpe/nix-config).
