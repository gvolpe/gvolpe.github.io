...
tags: ["nix", "nixos", "flakes", "ci", "garnix", "cachix"]
github_comments_issueid: "22"
---

[Garnix](https://garnix.io/) is a continuous integration (CI) service for Nix flakes that has been in Beta for a while.

{{< quote title="In their own words" >}}
