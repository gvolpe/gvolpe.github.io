...
tags: ["nix", "nixos", "flakes", "ci", "garnix", "cachix", "nixbuild"]
...
Here's what the [NixOS official documentation](https://nixos.org/manual/nix/stable/advanced-topics/distributed-builds.html) has to say on the topic:

{{< quote title="Remote Builds" >}}
