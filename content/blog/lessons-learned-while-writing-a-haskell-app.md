...
**NOTE**: you need to enable `FlexibleInstances`, `MultiParamTypeClasses` and `FunctionalDependencies`. Thanks to [/u/samb961](https://www.reddit.com/user/samb961/) for helping me out with this!
